  ...
  return (
    ...
    <div className="p-4 md:p-6">
      ...
      <Link href={buttonLink}>
        <span className="bg-[#617968] dark:hover:bg-[#242423] dark:hover:text-[#C0CFB2] text-[#F5F7EE] dark:bg-[#C0CFB2] dark:text-[#151515] px-4 py-2 md:px-6 md:py-2 rounded-full hover:bg-[#AABB99] transition duration-300 cursor-pointer">
          {buttonLabel}
        </span>
      </Link>
    </div>

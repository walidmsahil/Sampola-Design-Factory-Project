...
export default async function Contact({ params }) {
  ...
  <div className="container mx-auto px-4 lg:px-8">
    <div className="flex flex-col lg:flex-row justify-between">
      <div className="w-full lg:w-1/2">
        <div className="mb-8 lg:mb-32">
          <h2 className="text-[28px] lg:text-[36px] font-bold text-[#617968] mt-5 mb-5">Toimintasampo/Sampola</h2>
          <p className="text-[16px] lg:text-[20px]">Brahenkatu 26</p>
          <p className="text-[16px] lg:text-[20px]">13100 HÄMEENLINNA</p>
          <p className="text-[16px] lg:text-[20px]">y-tunnus 0116651-2</p>
          <p className="text-[16px] lg:text-[20px]">Toimisto, myynti ja asiakaspalvelu:</p>
          <p className="text-[16px] lg:text-[20px]">Ma-To 9-15</p>
          <p className="text-[16px] lg:text-[20px]">Pe 9-14</p>
          <p className="text-[16px] lg:text-[20px]">puh. 044 733 1563</p>
          <p className="text-[16px] lg:text-[20px]">Email: <a href="mailto:myynti.sampola@kpsaatio.fi">myynti.sampola(at)kpsaatio.fi</a></p>
        </div>

        <div className="mb-8 lg:mb-32">
          <h2 className="text-[28px] lg:text-[36px] font-bold text-[#617968] mt-5 mb-5">Työsampo</h2>
          <p className="text-[16px] lg:text-[20px]">Vastaava työvalmentaja</p>
          <p className="text-[16px] lg:text-[20px]">Kimmo Uschanoff</p>
          <p className="text-[16px] lg:text-[20px]">Puhelin: 050 375 0051</p>
          <p className="text-[16px] lg:text-[20px]">Email: <a href="mailto:kimmo.uschanoff@kpsaatio.fi">kimmo.uschanoff(at)kpsaatio.fi</a></p>
        </div>

        <div className="mb-8 lg:mb-32">
          <h2 className="text-[28px] lg:text-[36px] font-bold text-[#617968] mt-5 mb-5">Toimintasampo ryhmävastaava</h2>
          <p className="text-[16px] lg:text-[20px]">Noemi Olmedo-Jokiranta</p>
          <p className="text-[16px] lg:text-[20px]">Puhelin: 044 710 2055</p>
          <p className="text-[16px] lg:text-[20px]">Email: <a href="mailto:noemi.olmedo-jokiranta@kpsaatio.fi">noemi.olmedo-jokiranta(at)kpsaatio.fi</a></p>
        </div>

        <div className="mb-8 lg:mb-32">
          <h2 className="text-[28px] lg:text-[36px] font-bold text-[#617968] mt-5 mb-5">Verhoomo ja puutyö</h2>
          <p className="text-[16px] lg:text-[20px]">Työvalmentaja Simo Hirvilampi</p>
          <p className="text-[16px] lg:text-[20px]">Puhelin: 0400 962 523</p>
          <p className="text-[16px] lg:text-[20px]">Email: <a href="mailto:simo.hirvilampi@kpsaatio.fi">simo.hirvilampi(at)kpsaatio.fi</a></p>
          <p className="text-[16px] lg:text-[20px]">Kimmo Uschanoff</p>
          <p className="text-[16px] lg:text-[20px]">Puhelin: 050 375 0051</p>
        </div>
      </div>
    ...
    <div className="text-center py-12 ">
          <h2 className="text-[36px] font-bold text-[#617968] mb-10">Find us on social media</h2>
          <div className="flex justify-center space-x-20 px-5">
            {/* Facebook */}
            <div className="flex flex-col items-center">
              ...
              <p className="text-[16px]">facebook.com/Sampola</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[16px]">instagram.com/Sampola</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[16px]">youtube.com/Sampola</p>
            </div>
          </div>
        </div>
  </div>

    ...
    <div className="">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="my-8 p-6">
          <h2 className="text-2xl font-bold text-green-dark">Upholstery and restoration</h2>
          <p className="mt-4">
        ...
        <div className="my-8 p-6">
          <h2 className="text-2xl font-bold text-green-dark">Workshop shop Sampola</h2>
          <p className="mt-4">
        ...
        <div className="my-8 p-6">
          ...
          <div className="flex flex-col space-y-8 mt-6">
            ...
            <Image
              ...
              />
              <div>
                <h3 className="text-xl font-bold text-green-dark">Brushes</h3>
                <p className="mt-2">
                ...
                <button className="mt-4 bg-green text-white py-2 px-4 rounded-lg">
                  More info
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              />
              <div>
                <h3 className="text-xl font-bold text-green-dark">Upholstery accessories</h3>
                <p className="mt-2">
            ...
            <Image
              ...
              <div  className="flex flex-col items-center">
                <div className="p-6 mb-4">
                  <h3 className="text-xl font-bold text-green-dark">Wooden products</h3>
                  <p className="mt-2">
